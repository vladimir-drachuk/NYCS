...
export enum matchesActionType {
    ...
    updateTime = '[MATCHES] match time updated and go to server',
...
export const updateTime = createAction(matchesActionType.updateTime, props<ActionPayload<UpdateTime>>())
